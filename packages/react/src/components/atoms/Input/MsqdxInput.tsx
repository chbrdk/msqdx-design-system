...
const InputWrapper = styled(Box, {
    ...
    return {
        ...
        '& .msqdx-input-wrapper': {
            ...
            '&:hover': {
                backgroundColor:
                    inputState === 'disabled' ? MSQDX_INPUT.background.disabled : MSQDX_INPUT.background.hover,
                borderColor:
                    inputState === 'disabled'
                        ? MSQDX_INPUT.border.disabled
                        : borderColor
                          ? getBrandColor(borderColor)
                          : MSQDX_INPUT.border.hover,
            },
        ...
        '& .msqdx-input-helper': {
            ...
            color: inputState === 'error' ? MSQDX_COLORS.status.error : MSQDX_COLORS.light.textSecondary,
        },
    };
...
export const MsqdxInput = ({
    ...
    const inputState: InputState = disabled ? 'disabled' : error ? 'error' : success ? 'success' : 'default';
    ...
    const finalEndIcon = error ? 'ErrorOutline' : success ? 'CheckCircleOutline' : endIcon;
    ...
    return (
        ...
        >
            ...
            {(errorText || helperText) && <div className="msqdx-input-helper">{errorText || helperText}</div>}
        </InputWrapper>
    );
};
