...
export interface MsqdxLogoProps extends Omit<BoxProps, 'component'> {
  /**
   * Logo size variant
   * @default 'medium'
   */
...
const sizeMap = {
  ...
  medium: { width: 167, height: 40 },
  large: { width: 250, height: 60 },
  xlarge: { width: 334, height: 80 },
};
 ...
 * MsqdxLogo
 *
 * MSQDX brand logo component with size variants and color customization.
 *
 * @example
 * ```tsx
 * <MsqdxLogo size="medium" />
 * <MsqdxLogo size="large" color="white" />
 * <MsqdxLogo width={200} height={48} />
 * ```
 */
export const MsqdxLogo = ({
  size = 'medium',
  color = 'black',
  width,
  height,
