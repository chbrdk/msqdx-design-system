...
})<{ error?: boolean; success?: boolean; disabled?: boolean; borderColor?: BrandColor; selectSize?: SelectSize }>(
    ({ error, success, disabled, borderColor, selectSize = 'small' }) => {
        ...
        return {
            ...
            '&.Mui-focused': {
                ...
                boxShadow: error
                    ? MSQDX_INPUT.focusRing.error
                    : success
                      ? MSQDX_INPUT.focusRing.success
                      : MSQDX_INPUT.focusRing.default,
