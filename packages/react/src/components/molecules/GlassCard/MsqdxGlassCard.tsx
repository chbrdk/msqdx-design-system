...
import { MSQDX_COLORS, MSQDX_SPACING, MSQDX_EFFECTS } from "@msqdx/tokens";
...
const StyledCard = styled(Box, {
  ...
  ...(borderRadiusVariant ? {
    ...
    borderRadius: MSQDX_SPACING.borderRadius.lg, // 40px - default for mobile/tablet
    [theme.breakpoints.up('md')]: { 
      borderRadius: MSQDX_SPACING.borderRadius.button  // 32px - for desktop
    },
  }),
  ...
  ...(hoverable && {
    ...
    "&:hover": {
      ...
      boxShadow: theme.palette.mode === 'dark' ? MSQDX_EFFECTS.shadows.lg : MSQDX_EFFECTS.shadows.md,
    },
  }),
