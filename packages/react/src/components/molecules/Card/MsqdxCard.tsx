...
import { MSQDX_NEUTRAL, MSQDX_SPACING, MSQDX_TYPOGRAPHY } from '@msqdx/tokens';
            ...
            >
                {hasHeader && (
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: `${MSQDX_SPACING.gap.xxs}px` }}>
                        {eyebrow != null && <MsqdxTypography eyebrow>{eyebrow}</MsqdxTypography>}
                        ...
                        {subtitle != null && (
                            <MsqdxTypography variant="body2" color={`${MSQDX_NEUTRAL[700]}`}>
                                {subtitle}
                            </MsqdxTypography>
                        )}
                    </Box>
                ...
                {hasFooterRow && (
                    <>
                        {footerDivider && <MsqdxDivider spacing="xs" />}
                        <Box
                            sx={{
                                flexShrink: 0,
                                display: 'flex',
