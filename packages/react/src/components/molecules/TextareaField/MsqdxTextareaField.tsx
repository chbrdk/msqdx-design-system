...
})<{ error?: boolean; success?: boolean; disabled?: boolean; borderColor?: BrandColor; textareaSize?: TextareaSize }>(
    ({ error, success, disabled, borderColor, textareaSize = 'medium' }) => {
            ...
            '& .MuiOutlinedInput-root': {
                ...
                '&.Mui-focused': {
                    ...
                    boxShadow: borderColor
                        ? `0 0 0 4px ${alpha(getBorderColor(), 0.1)}`
